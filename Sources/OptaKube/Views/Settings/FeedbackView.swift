...
/// Lightweight feedback / bug-report form. Composes a pre-filled GitHub issue and
/// opens it in the browser — the user reviews and submits with their own account.
/// A "Copy report" fallback covers anyone without GitHub. No backend, no auth.
struct FeedbackView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            Text("This opens a pre-filled GitHub issue in your browser — review and submit it there. No account? Use Copy report and send it however you like. Only the info shown above is attached — never your clusters or credentials.")
                .font(.caption)
                .foregroundStyle(.secondary)
